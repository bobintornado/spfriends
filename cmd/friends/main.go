...
import (
	...
	itrace "github.com/bobintornado/spfriends/internal/platform/trace"
	"go.opencensus.io/trace"
)

/*
ZipKin: http://localhost:9411
AddLoad: hey -m GET -c 10 -n 10000 "http://localhost:3000/getFriendsOfUser"
...
func main() {
	...
	c, err := cfg.New(cfg.EnvProvider{Namespace: "FRIENDS"})
	if err != nil {
